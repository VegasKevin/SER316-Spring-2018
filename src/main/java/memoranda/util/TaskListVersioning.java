...
public class TaskListVersioning {
    ...
    public static final String[] VERSIONS = new String[] { "-//Memoranda//DTD Tasklist 1.0//EN",
    ...
    public static int getIndexOfVersion(String publicId) {
        if (publicId == null) {
        // earlier versions do not have public ID, it is version 1.0 which is the first
        // entry
        return 0;
        }
    ...
    private static void upgrade1_1d1(String[] projectIds) {
        ...
        // Decided not to change the date format after all but I'm leaving this code
        // here
