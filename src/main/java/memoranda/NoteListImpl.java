...
public class NoteListImpl implements INoteList {
    ...
    // public static final String NS_JNNL =
    // "http://www.openmechanics.org/2003/jnotes-noteslist";
    ...
    /*
     * @see net.sf.memoranda.NoteList#removeNoteForDate(net.sf.memoranda.date.
     * CalendarDate)
     */
    /*
     * public void removeNoteForDate(CalendarDate date) { Day d = getDay(date); if
     * (d == null) return; d.getElement().getParent().removeChild(d.getElement()); }
     */
    ...
    /*
     * private Vector getYears() { Vector v = new Vector(); Elements yrs =
     * _root.getChildElements("year"); for (int i = 0; i < yrs.size(); i++)
     * v.add(new Year(yrs.get(i))); return v; }
     */
    ...
    private class Month {
        ...
        private Day createDay(int d) {
            ...
            /*
             * el.addAttribute( new Attribute( "date", new CalendarDate( d, getValue(), new
             * Integer(((Element)
             * mElement.getParent()).getAttribute("year").getValue()).intValue())
             * .toString()));
             */
    ...
    private class Day {
        ...
        public NoteElement createNote(String d) {
            ...
            /*
             * el.addAttribute(new Attribute("day", new Integer(d).toString()));
             * el.addAttribute( new Attribute( "date", new CalendarDate( 10, 10,
             * 2004).toString()));
             */
            dEl.appendChild(el);
