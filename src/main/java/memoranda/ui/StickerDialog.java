...
public class StickerDialog extends JDialog {
    ...
    Border border1;
    Border border2;
    Color[] colors = { Color.YELLOW, Color.ORANGE, Color.RED, Color.BLUE, Color.GREEN, Color.CYAN, Color.MAGENTA,
            Color.BLACK, Color.WHITE, Color.PINK };
    String[] colorLabels = { Local.getString("Yellow"), Local.getString("Orange"), Local.getString("Red"),
            Local.getString("Blue"), Local.getString("Green"), Local.getString("Cyan"), Local.getString("Magenta"),
            Local.getString("Black"), Local.getString("White"), Local.getString("Pink"),
            Local.getString("Custom") + "..." };
    String[] priorities = { Local.getString("HIGHEST"), Local.getString("HIGH"), Local.getString("NORMAL"),
            Local.getString("LOW"), Local.getString("LOWEST") };
    int[] font = { 10, 15, 20 };
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(
                new ImageIcon(main.java.memoranda.ui.StickerDialog.class.getResource("/ui/icons/sticker48.png")));
    ...
    public String getStickerTextColor() {
        return "#" + Integer.toHexString(stickerText.getForeground().getRGB() - 0xFF000000).toUpperCase();
    }

    public String getStickerColor() {
        return "#" + Integer.toHexString(stickerText.getBackground().getRGB() - 0xFF000000).toUpperCase();
    }
