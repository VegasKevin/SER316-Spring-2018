...
public class EventDialog extends JDialog implements WindowListener {
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(new ImageIcon(main.java.memoranda.ui.EventDialog.class.getResource("/ui/icons/event48.png")));
        ...
        // Build RepeatPanel
        repeatBorder = new TitledBorder(BorderFactory.createLineBorder(Color.gray, 1), Local.getString("Repeat"));
        ...
        setStartDateB
                .setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/calendar.png")));
        ...
        setEndDateB.setText("");
        setEndDateB.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/calendar.png")));
