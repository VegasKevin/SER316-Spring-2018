...
public class AddResourceDialog extends JDialog {
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(
                new ImageIcon(main.java.memoranda.ui.AddResourceDialog.class.getResource("/ui/icons/resource48.png")));
    ...
    /**
     * set CANCELLED variable to false so we can know the user pressed the ok buton
    ...
    /**
     * enable localRB fields. Request focus for the text field so the user can start
     * typing and set the pathField text selected
     */
    ...
    /**
     * enable inetShorcutRB fields. Request focus for the text field so the user can
     * start typing and set the urlField text selected
     */
    ...
    void browseB_actionPerformed(ActionEvent e) {
        ...
        if (chooser.showOpenDialog(this) != JFileChooser.APPROVE_OPTION)
            return;
        /*
         * try { Context.put("LAST_SELECTED_RESOURCE_FILE", chooser.getSelectedFile());
         * } catch (Exception ex) {}
         */
    ...
    void checkOkEnabled() {
        okB.setEnabled((localFileRB.isSelected() && pathField.getText().length() > 0)
