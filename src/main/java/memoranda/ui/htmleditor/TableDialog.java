...
public class TableDialog extends JDialog {
    ...
    String[] aligns = { "", Local.getString("left"), Local.getString("center"), Local.getString("right") };
    String[] valigns = { "", Local.getString("top"), Local.getString("center"), Local.getString("bottom") };
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(new ImageIcon(
                main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/htmleditor/icons/tablebig.png")));
        ...
        bgColorB.setIcon(new ImageIcon(
                main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/htmleditor/icons/color.png")));
