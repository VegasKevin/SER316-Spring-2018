...
public class FontDialog extends JDialog {
    ...
    public JComboBox fontSizeCB = new JComboBox(new Object[] { "", "1", "2", "3", "4", "5", "6", "7" });
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(new ImageIcon(
                main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/htmleditor/icons/fontbig.png")));
        ...
        fontSizeCB.setBorder(new TitledBorder(BorderFactory.createEmptyBorder(), Local.getString("Font size")));
        ...
        colorB.setIcon(new ImageIcon(
                main.java.memoranda.ui.htmleditor.FontDialog.class.getResource("/htmleditor/icons/color.png")));
        ...
        samplePanel.setBorder(BorderFactory.createTitledBorder(Local.getString("Sample")));
