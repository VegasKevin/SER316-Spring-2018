...
public class HTMLEditor extends JPanel {
    ...
    public Action ulAction = new HTMLEditorAction(Local.getString("Unordered list"),
            new ImageIcon(cl.getResource("/htmleditor/icons/listunordered.png"))) {
        public void actionPerformed(ActionEvent e) {
    ...
    public Action propsAction = new HTMLEditorAction(Local.getString("Object properties"),
    ...
    public Action insertHRAction = new HTMLEditorAction(Local.getString("Insert horizontal rule"),
        ...
        public void actionPerformed(ActionEvent e) {
            /*
             * String elName =
             * document.getParagraphElement(editor.getCaretPosition()).getName(); HTML.Tag
             * tag = HTML.getTag(elName); if (elName.toUpperCase().equals("P-IMPLIED")) tag
             * = HTML.Tag.IMPLIED; HTMLEditorKit.InsertHTMLTextAction hta = new
             * HTMLEditorKit.InsertHTMLTextAction("insertHR", " <hr> ", tag, HTML.Tag.HR);
             */
            try {
    ...
    public Action findAction = new HTMLEditorAction(Local.getString("Find & Replace"),
    ...
    private void doCopy() {
         ...
         * java.awt.Toolkit.getDefaultToolkit().getSystemClipboard(); try { String text
         * = editor.getSelectedText(); //.getText(editor.getSelectionStart(),
         * editor.getSelectionEnd()-editor.getSelectionStart()); clip.setContents(new
         * java.awt.datatransfer.StringSelection(text), null); } catch (Exception e) {
         * e.printStackTrace();
         */
        ...
        try {
        editorKit.write(sw, document, editor.getSelectionStart(),
    ...
    private void doPaste() {
        ...
        document.replace(editor.getSelectionStart(), editor.getSelectionEnd() - editor.getSelectionStart(), txt,
         ...
         * insertTextInElement(el, content.getTransferData(new DataFlavor(String.class,
         * "String")).toString(),
         */
    ...
    /*
     * private void insertTextInElement(Element el, String text, int pos) { String
     * elName = el.getName(); StringWriter sw = new StringWriter(); String copy1;
     * String copy2; try { StringWriter sw1 = new StringWriter();
     * editorKit.write(sw1, document, el.getStartOffset(), pos -
     * el.getStartOffset()); copy1 = sw1.toString(); StringWriter sw2 = new
     * StringWriter(); editorKit.write(sw2, document, pos, el.getEndOffset() - pos);
     * copy2 = sw2.toString(); String copy = copy1+text+copy2; ?)>")[1]; copy =
     * copy.split(" </" + elName + "> ")[0]; document.setInnerHTML(el, copy); }
    ...
    String[] elementTypes = { Local.getString("Paragraph"), Local.getString("Header") + " 1",
            Local.getString("Header") + " 2", Local.getString("Header") + " 3", Local.getString("Header") + " 4",
            Local.getString("Header") + " 5", Local.getString("Header") + " 6", Local.getString("Preformatted"),
            // "Address",
    ...
    String[] inlineTypes = { Local.getString("Normal"), Local.getString("Emphasis"), Local.getString("Strong"),
    ...
    void jbInit() throws Exception {
        ...
        cutAction.putValue(Action.SMALL_ICON, new ImageIcon(cl.getResource("/htmleditor/icons/cut.png")));
        ...
        copyAction.putValue(Action.SMALL_ICON, new ImageIcon(cl.getResource("/htmleditor/icons/copy.png")));
        ...
        pasteAction.putValue(Action.SMALL_ICON, new ImageIcon(cl.getResource("/htmleditor/icons/paste.png")));
        ...
        stylePasteAction.putValue(Action.ACCELERATOR_KEY,
        ...
        breakAction.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.SHIFT_MASK));
        ...
        findAction.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F, KeyEvent.CTRL_MASK));
         ...
         * "/htmleditor/icons/alignjust.png"))); jAlignActionB.setMaximumSize(new
         * Dimension(22, 22)); jAlignActionB.setMinimumSize(new Dimension(22, 22));
        ...
        /*
         * editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.
         * VK_B, KeyEvent.CTRL_MASK), boldAction);
         * editor.getKeymap().addActionForKeyStroke(
         * KeyStroke.getKeyStroke(KeyEvent.VK_I, KeyEvent.CTRL_MASK), italicAction);
         * editor.getKeymap().addActionForKeyStroke(
        ...
        /*
         * editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.
         * VK_Z, KeyEvent.CTRL_MASK), undoAction);
         * editor.getKeymap().addActionForKeyStroke(
         * KeyStroke.getKeyStroke(KeyEvent.VK_Z, KeyEvent.CTRL_MASK +
         * KeyEvent.SHIFT_MASK), redoAction); editor.getKeymap().addActionForKeyStroke(
        ...
        editor.getKeymap().removeKeyStrokeBinding(KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.CTRL_MASK));
        editor.getKeymap().removeKeyStrokeBinding(KeyStroke.getKeyStroke(KeyEvent.VK_V, KeyEvent.CTRL_MASK));
        editor.getKeymap().removeKeyStrokeBinding(KeyStroke.getKeyStroke(KeyEvent.VK_X, KeyEvent.CTRL_MASK));

        editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.CTRL_MASK), copyAction);
        editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_V, KeyEvent.CTRL_MASK),
                pasteAction);
        editor.getKeymap().addActionForKeyStroke(
                KeyStroke.getKeyStroke(KeyEvent.VK_V, KeyEvent.CTRL_MASK + KeyEvent.SHIFT_MASK), stylePasteAction);
        editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_X, KeyEvent.CTRL_MASK), cutAction);

        editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_F, KeyEvent.CTRL_MASK), findAction);
        /*
         * editor.getKeymap().addActionForKeyStroke(
         ...
         * ImageIcon(net.sf.memoranda.ui.htmleditor.AppFrame.class.getResource(
         * "/htmleditor/icons/undo16.png")));
         * 
         ...
         * KeyEvent.CTRL_MASK + KeyEvent.SHIFT_MASK)); jMenuItemRedo.setIcon( new
         * ImageIcon(net.sf.memoranda.ui.htmleditor.AppFrame.class.getResource(
         * "/htmleditor/icons/redo16.png")));
         * 
         ...
         * ImageIcon(net.sf.memoranda.ui.htmleditor.AppFrame.class.getResource(
         * "/htmleditor/icons/copy.png")));
         * 
         * jMenuItemPaste.setAction(pasteAction); jMenuItemPaste.setText("Paste");
         * jMenuItemPaste.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V,
         * KeyEvent.CTRL_MASK)); jMenuItemPaste.setIcon( new
         * ImageIcon(net.sf.memoranda.ui.htmleditor.AppFrame.class.getResource(
         * "/htmleditor/icons/paste.png")));
         * 
         * jMenuItemProp.setAction(propsAction); jMenuItemProp.setText("Properties");
         * jMenuItemProp.setIcon(
         */

        /*
         * defaultPopupMenu.add(jMenuItemUndo); defaultPopupMenu.add(jMenuItemRedo);
         * defaultPopupMenu.addSeparator(); defaultPopupMenu.add(jMenuItemCut);
         * defaultPopupMenu.add(jMenuItemCopy); defaultPopupMenu.add(jMenuItemPaste);
        ...
        /*
         * tablePopupMenu.add(jMenuItemUndo); tablePopupMenu.add(jMenuItemRedo);
         * tablePopupMenu.addSeparator(); tablePopupMenu.add(jMenuItemCut);
         * tablePopupMenu.add(jMenuItemCopy); tablePopupMenu.add(jMenuItemPaste);
         * tablePopupMenu.addSeparator(); tablePopupMenu.add(jMenuItemInsCell);
    ...
    class UndoAction extends AbstractAction {
        public UndoAction() {
            ...
            setEnabled(false);
            putValue(Action.SMALL_ICON, new ImageIcon(cl.getResource("/htmleditor/icons/undo16.png")));
    ...
    class RedoAction extends AbstractAction {
        public RedoAction() {
            ...
            setEnabled(false);
            putValue(Action.SMALL_ICON, new ImageIcon(cl.getResource("/htmleditor/icons/redo16.png")));
            putValue(Action.ACCELERATOR_KEY,
                    KeyStroke.getKeyStroke(KeyEvent.VK_Z, KeyEvent.CTRL_MASK + KeyEvent.SHIFT_MASK));
        }
    ...
    void editor_caretUpdate(CaretEvent e) {
        ...
        /*
         * currentParaElement = document.getParagraphElement(editor.getCaretPosition());
        ...
        underActionB.setBorderPainted(under);
        /*
         * String iName = document .getCharacterElement(editor.getCaretPosition())
         * .getAttributes() .getAttribute(StyleConstants.NameAttribute) .toString()
         */
        ...
        /*
         * String ppName =
         * document.getParagraphElement(editor.getCaretPosition()).getParentElement().
         * getName().toUpperCase(); System.out.print(ppName+"->"+pName+":");
         * 
         * AbstractDocument.BranchElement pEl =
         * (AbstractDocument.BranchElement)document.getParagraphElement(editor.
         * getCaretPosition()); Element el =
         * pEl.positionToElement(editor.getCaretPosition());
         * System.out.println(el.getAttributes().getAttribute(StyleConstants.
         * NameAttribute)+", "+pEl.getElementCount()+"/"+el.getElementCount());
         */

    }

    public void ulActionB_actionPerformed(ActionEvent e) {
        String parentname = document.getParagraphElement(editor.getCaretPosition()).getParentElement().getName();
        ...
        /*
         * Element pEl = document.getParagraphElement(editor.getCaretPosition());
         * StringWriter sw = new StringWriter(); try { editorKit.write(sw, document,
         * pEl.getStartOffset(), pEl.getEndOffset()-pEl.getStartOffset()); String copy =
         ...
         * System.out.println(copy); } catch (Exception ex){ ex.printStackTrace();
         */
    ...
    class ParaBreakAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
             ...
             * HTMLEditorKit.InsertHTMLTextAction("insertLI", " <li> </li> ", parentTag,
             * HTML.Tag.LI);
             */
            } else {
            try {
            ...
            HTMLEditorKit.InsertHTMLTextAction pAction = new HTMLEditorKit.InsertHTMLTextAction("insertP", "<p></p>",
                    listParentTag, HTML.Tag.P);
            ...
            if (editor.getCaretPosition() > 0)
                removeIfEmpty(document.getParagraphElement(editor.getCaretPosition() - 1));
            HTMLEditorKit.InsertHTMLTextAction pAction = new HTMLEditorKit.InsertHTMLTextAction("insertP", "<p></p>",
                    parentTag, HTML.Tag.P);
            System.out.println("PRE");
            pAction.actionPerformed(e);
            } else if (elName.equals("P-IMPLIED")) {
            /*
             * HTML.Tag sParentTag =
             * HTML.getTag(elem.getParentElement().getParentElement().getName()); if
             * (editor.getCaretPosition() > 0)
             * removeIfEmpty(document.getParagraphElement(editor.getCaretPosition() - 1));
             * HTMLEditorKit.InsertHTMLTextAction pAction = new
             * HTMLEditorKit.InsertHTMLTextAction("insertP", " <p></p> ", sParentTag,
             * HTML.Tag.P); System.out.println(sParentTag.toString());
             */
            try {
            ...
            /*
             * HTMLEditorKit.InsertHTMLTextAction pAction = new
             * HTMLEditorKit.InsertHTMLTextAction("insertP"," <p></p> ", HTML.Tag.BODY,
             * HTML.Tag.P);
             */
    ...
    class BreakAction extends AbstractAction {
        BreakAction() {
            super(Local.getString("Insert break"), new ImageIcon(cl.getResource("/htmleditor/icons/break.png")));
        }
        ...
        public void actionPerformed(ActionEvent e) {
             ...
             * (elName.toUpperCase().equals("P-IMPLIED"))) { editor.replaceSelection("\r");
             * return;
             */
            ...
            HTMLEditorKit.InsertHTMLTextAction hta = new HTMLEditorKit.InsertHTMLTextAction("insertBR", "<br>", tag,
                    HTML.Tag.BR);
    ...
    class InsertTableRowAction extends AbstractAction {
        InsertTableRowAction() {
            ...
            this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.CTRL_MASK));
        }

        public void actionPerformed(ActionEvent e) {
            String trTag = "<tr>";
            Element tr = document.getParagraphElement(editor.getCaretPosition()).getParentElement().getParentElement();
             ...
             * HTMLEditorKit.InsertHTMLTextAction("insertTR",trTag, HTML.Tag.TABLE,
             * HTML.Tag.TR);
             */
            try {
        ...
        public boolean isEnabled() {
            if (document == null)
                return false;
            return document.getParagraphElement(editor.getCaretPosition()).getParentElement().getName().toUpperCase()
                    .equals("TD");
        }
    ...
    public void lAlignActionB_actionPerformed(ActionEvent e) {
        HTMLEditorKit.AlignmentAction aa = new HTMLEditorKit.AlignmentAction("leftAlign", StyleConstants.ALIGN_LEFT);
    ...
    public void rAlignActionB_actionPerformed(ActionEvent e) {
        HTMLEditorKit.AlignmentAction aa = new HTMLEditorKit.AlignmentAction("rightAlign", StyleConstants.ALIGN_RIGHT);
        aa.actionPerformed(e);
    }
    ...
    public void imageActionB_actionPerformed(ActionEvent e) {
         ...
         * chooser.setFileHidingEnabled(false); chooser.setDialogTitle("Choose image
        ...
        try {
        String imgTag = "<img src=\"" + path + "\" alt=\"" + dlg.altField.getText() + "\" ";
    ...
    public void tableActionB_actionPerformed(ActionEvent e) {
         ...
         * HTMLEditorKit.InsertHTMLTextAction("insertTABLE",tableTag, HTML.Tag.BODY,
         * HTML.Tag.TABLE);
         * 
         */
        ...
        try {
        editorKit.insertHTML(document, editor.getCaretPosition(), tableTag, 1, 0, HTML.Tag.TABLE);
        // removeIfEmpty(document.getParagraphElement(editor.getCaretPosition()-1));
        } catch (Exception ex) {
        ex.printStackTrace();
        }
    ...
    public void linkActionB_actionPerformed(ActionEvent e) {
        ...
        editor.replaceSelection("");
        try {
        editorKit.insertHTML(document, editor.getCaretPosition(), aTag, 0, 0, HTML.Tag.A);
        } catch (Exception ex) {
        ex.printStackTrace();
        }
    }

    void setLinkProperties(Element el, String href, String target, String title, String name) {
        LinkDialog dlg = new LinkDialog(null);
        dlg.setLocation(linkActionB.getLocationOnScreen());
        dlg.setModal(true);
        ...
        try {
        dlg.txtDesc.setText(document.getText(el.getStartOffset(), el.getEndOffset() - el.getStartOffset()));
        } catch (Exception ex) {
        ex.printStackTrace();
        }
        ...
        // String p = "";
        /*
         * SimpleAttributeSet attrs = new SimpleAttributeSet(el.getAttributes()); if
         * (dlg.urlField.getText().length() >0) {
         * attrs.addAttribute(HTML.Attribute.HREF, dlg.urlField.getText()); p +=
         * "href="+dlg.urlField.getText()+" "; } if (dlg.nameField.getText().length()
         * >0) { attrs.addAttribute(HTML.Attribute.NAME, dlg.nameField.getText()); p +=
         * "name="+dlg.nameField.getText()+" "; } if (dlg.titleField.getText().length()
         * >0) { attrs.addAttribute(HTML.Attribute.TITLE, dlg.titleField.getText()); p
         * += "title="+dlg.titleField.getText()+" "; } if (dlg.newWinChB.isSelected()) {
         * attrs.addAttribute(HTML.Attribute.TARGET, "_blank"); p += "target=_blank "; }
         * attrs.addAttribute(StyleConstants.NameAttribute, "a");
         * attrs.addAttribute(HTML.Tag.A, p);
         */
        String aTag = "<a";
        if (dlg.txtURL.getText().length() > 0)
            aTag += " href=\"" + dlg.txtURL.getText() + "\"";
    ...
    void setImageProperties(Element el, String src, String alt, String width, String height, String hspace,
        ...
        if (dlg.CANCELLED)
            return;
        String imgTag = "<img src=\"" + dlg.fileField.getText() + "\" alt=\"" + dlg.altField.getText() + "\" ";
        String w = dlg.widthField.getText();
        try {
        Integer.parseInt(w, 10);
        imgTag += " width=\"" + w + "\" ";
    ...
    void setTableProperties(Element td) {
        ...
        if (tda.isDefined(HTML.Attribute.ALIGN))
            dlg.tdAlignCB.setSelectedItem(tda.getAttribute(HTML.Attribute.ALIGN).toString().toLowerCase());
        if (tda.isDefined(HTML.Attribute.VALIGN))
            dlg.tdValignCB.setSelectedItem(tda.getAttribute(HTML.Attribute.VALIGN).toString().toLowerCase());
        ...
        if (tra.isDefined(HTML.Attribute.ALIGN))
            dlg.trAlignCB.setSelectedItem(tra.getAttribute(HTML.Attribute.ALIGN).toString().toLowerCase());
        if (tra.isDefined(HTML.Attribute.VALIGN))
            dlg.trValignCB.setSelectedItem(tra.getAttribute(HTML.Attribute.VALIGN).toString().toLowerCase());
        ...
        if (ta.isDefined(HTML.Attribute.ALIGN))
            dlg.alignCB.setSelectedItem(ta.getAttribute(HTML.Attribute.ALIGN).toString().toLowerCase());
        if (ta.isDefined(HTML.Attribute.VALIGN))
            dlg.vAlignCB.setSelectedItem(ta.getAttribute(HTML.Attribute.VALIGN).toString().toLowerCase());
        ...
        sw = new StringWriter();
        editorKit.write(sw, document, tr.getStartOffset(), tr.getEndOffset() - tr.getStartOffset());
        copy = sw.toString();
        ...
        sw = new StringWriter();
        editorKit.write(sw, document, table.getStartOffset(), table.getEndOffset() - table.getStartOffset());
        copy = sw.toString();
    ...
    void blockCB_actionPerformed(ActionEvent e) {
        ...
        /*
         * HTML.Tag parentTag =
         * HTML.getTag(document.getParagraphElement(editor.getCaretPosition()).
         * getParentElement().getName()); HTML.Tag tag = null; String tagText = "";
         * switch (sel) { case T_P: tag = HTML.Tag.P; tagText=" <p></p> ";break; //case
         * T_PRE: tag = HTML.Tag.PRE; tagText=" <pre></pre> ";break; case T_H1: tag =
         * HTML.Tag.H1; tagText=" <h1></h1> ";break; case T_H2: tag = HTML.Tag.H2;
         * tagText=" <h2></h2> ";break; case T_H3: tag = HTML.Tag.H3;
         * tagText=" <h3></h3> ";break; case T_H4: tag = HTML.Tag.H4;
         * tagText=" <h4></h4> ";break; case T_H5: tag = HTML.Tag.H5;
         * tagText=" <h5></h5> ";break; case T_H6: tag = HTML.Tag.H6;
         * tagText=" <h6></h6> ";break; }
         * 
         * HTMLEditorKit.InsertHTMLTextAction iAction = new
         * HTMLEditorKit.InsertHTMLTextAction("insertTag",tagText, parentTag, tag);
         * iAction.actionPerformed(e);
        ...
        if (editor.getSelectionEnd() - editor.getSelectionStart() > 0)
            document.setParagraphAttributes(editor.getSelectionStart(),
    ...
    public void propsActionB_actionPerformed(ActionEvent e) {
        ...
        /*
         * Element p = document.getParagraphElement(editor.getCaretPosition()); do {
         * System.out.print(p.getName()+" / "); p = p.getParentElement();}
         */
        ...
        /*
         * Enumeration en = attrs.getAttributeNames(); Object k = en.nextElement();
         * while (en.hasMoreElements()) {
         * System.out.println(k+" = '"+attrs.getAttribute(k)+"'"); k = en.nextElement();
         */
     ...
     * (editor.getSelectedText() != null) text = editor.getSelectedText(); String
     * tag = " <code> " + text + " </code> "; if (editor.getCaretPosition() ==
     * document.getLength()) tag += "&nbsp;"; editor.replaceSelection(""); try {
     * editorKit.insertHTML(document, editor.getCaretPosition(), tag, 0, 0,
     * HTML.Tag.CODE); } catch (Exception ex) { ex.printStackTrace(); } }
     * 
     * void dotestClearStyle(ActionEvent e) { Element el =
     * document.getCharacterElement(editor.getCaretPosition()); SimpleAttributeSet
    ...
    String setFontProperties(Element el, String text) {
         ...
         * ea.getAttribute(HTML.Tag.FONT).toString().split(" "); for (int i = 0; i <
         * param.length; i++) if (param[i].startsWith("face="))
        ...
        dlg.colorField.setText(Util.encodeColor((Color) ea.getAttribute(StyleConstants.Foreground)));
        Util.setColorField(dlg.colorField);
    ...
    void inlineCB_actionPerformed(ActionEvent e) {
        ...
        if (editor.getSelectionEnd() > editor.getSelectionStart())
            ...
            document.setCharacterAttributes(el.getStartOffset(), el.getEndOffset() - el.getStartOffset(), attrs, true);
        return;
        }
        String text = "&nbsp;";
        if (editor.getSelectedText() != null)
        ...
        case I_CUSTOM:
            tag = "font";
            att = setFontProperties(document.getCharacterElement(editor.getCaretPosition()), editor.getSelectedText());
            if (att == null)
                return;
            break;
        }
    ...
    public void setStyleSheet(Reader r) {
         ...
         * net.sf.memoranda.ui.htmleditor.HTMLEditor.class.getResourceAsStream(
         * "/htmleditor/css/default.css")),
         */
