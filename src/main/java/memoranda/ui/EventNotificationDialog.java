...
public class EventNotificationDialog extends JFrame {
    ...
    public EventNotificationDialog(String title, String time, String text) {
        ...
        timeLabel.setIcon(new ImageIcon(main.java.memoranda.ui.TaskDialog.class.getResource("/ui/icons/event48.png")));
    ...
    void jbInit() throws Exception {
        ...
        this.setIconImage(
                new ImageIcon(EventNotificationDialog.class.getResource("/ui/icons/jnotes16.png")).getImage());
    ...
    private void playSoundNotification() {
        ...
        if (Configuration.get("NOTIFY_SOUND").equals("DEFAULT"))
            url = EventNotificationDialog.class.getResource("/ui/beep.wav");
        else
            try {
        ...
        new ExceptionDialog(ex, "Error loading audioclip from " + url,
