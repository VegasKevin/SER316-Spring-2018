...
public class EventImpl implements IEvent, Comparable {
    ...
    private Element _elemment = null;
     ...
     */
    public int getHour() {
        return new Integer(_elemment.getAttribute("hour").getValue()).intValue();
    }
    ...
    public int getMinute() {
        return new Integer(_elemment.getAttribute("min").getValue()).intValue();
    }
    ...
    public CalendarDate getStartDate() {
        Attribute a = _elemment.getAttribute("startDate");
    ...
    public CalendarDate getEndDate() {
        Attribute a = _elemment.getAttribute("endDate");
        if (a != null) return new CalendarDate(a.getValue());
        return null;
    }
    /**
    ...
    public int getPeriod() {
        Attribute a = _elemment.getAttribute("period");
     ...
     */
    public String getId() {
        Attribute a = _elemment.getAttribute("id");
    ...
    public int getRepeat() {
        Attribute a = _elemment.getAttribute("repeat-type");
        if (a != null) return new Integer(a.getValue()).intValue();
        return 0;
    }
    /**
	...
	public boolean getWorkingDays() {
        Attribute a = _elemment.getAttribute("workingDays");
